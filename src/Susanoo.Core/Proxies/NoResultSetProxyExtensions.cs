...
namespace Susanoo
{
    ...
    public static class NoResultSetProxyExtensions
    {
        ...
        public static INoResultCommandProcessor<TFilter> WithTransforms<TFilter>(
            ...
            Action<IExecutableCommandInfo> queryInspector = null)
        {
            ...
            return source.InterceptOrProxyWith(s => new NoResultSetTransformProxy<TFilter>(s, transforms(s), queryInspector));
        }
